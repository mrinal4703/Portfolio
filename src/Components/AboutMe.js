...
//           <img src={melappy} className='w-[150px] md:w-[300px] mt-[-100px] mb-0' alt=''/>
//         </div>
...
//           <div
//             key={index}
//             className='flex relative w-full items-center justify-center flex-col m-2 group md:hover:bg-violet-900 rounded-lg py-2'
//           >
...
//             <h1 className='text-[12px] text-center md:group-hover:text-gray-200 text-gray-500 px-7'>
//               {item.desc}
//             </h1>
//           </div>
//         ))}
//       </div>          
//       {showTimeline && (
//         <div className='w-4/6 transition-all ease-in-out bg-violet-900 mx-auto mb-0 rounded-lg'>
//           <VerticalTimeline>
...
//                   <div className={`bg-white w-full transition-all ease-in-out hover:scale-110 justify-center p-2 m-0 text-center items-center group md:hover:bg-violet-900 rounded-lg ${index % 2 === 0 ? 'md:w-full md:order-first' : 'md:w-full md:order-last'}`}>
//                     <h1 className='text-[18px] vertical-timeline-element-title mt-2 font-bold md:group-hover:text-white'>
//                       {item.educationName}
//                     </h1>
//                     <h3 className='text-[15px] text-center my-2 md:group-hover:text-gray-200 text-gray-500'>
//                       {item.schoolName}
//                     </h3>
//                     <h3 className='text-[12px] text-center my-2 md:group-hover:text-gray-200 text-gray-500'>
//                       {item.text}
//                     </h3>
//                     <h3 className='text-[12px] text-center mb-0 md:group-hover:text-gray-200 text-gray-500'>
//                       {item.performance}
//                     </h3>
//                   </div>
//               </VerticalTimelineElement>
