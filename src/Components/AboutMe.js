              ...
              <VerticalTimeline>
                  {Education.map((item) => (
                      <VerticalTimelineElement
                          ...
                          date={<span className="text-slate-50">{item.date}</span>}
                          icon={
                              <div
                      ...
                      >
                          <div
                              className='bg-white w-full transition-all ease-in-out hover:scale-110 justify-center p-1 m-0 text-center items-center group md:hover:bg-violet-900 rounded-lg'>
                              ...
                              <div className='text-[10px] text-left my-2 md:group-hover:text-gray-200 text-gray-500'>
                                  {item.text.map((point, index) => (
                                      <p key={index} className="block mb-1 whitespace-pre-line">{point}</p>
                                  ))}
                              </div>
