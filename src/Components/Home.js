                            ...
                            <div className='flex w-full flex-col bg-transparent items-start content-end'>
                                ...
                                <div className={'md:flex md:flex-row-reverse xls:flex xls:flex-col'}>
                                    ...
                                    <div className={'md:w-1/2 md:mr-80 xls:w-screen'}>
                                        <h1 className='lg:my-5 md:my-2 text-neutral-300 text-base lg:text-base md:text-sm sm:text-sm lg:text-white md:text-white sm:text-white xls:text-black xls:text-[14px] xls:font-medium lg:mt-2 xls:mt-0'>
